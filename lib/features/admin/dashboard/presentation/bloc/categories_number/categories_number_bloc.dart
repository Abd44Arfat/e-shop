...
class CategoriesNumberBloc
  ...
  CategoriesNumberBloc(this._repo) : super(CategoriesNumberState.loading()) {
    on<GetCategoriesNumberEvent>(_getCategoriesNumber);
  }
  final DashBoardRepo _repo;
  FutureOr<void> _getCategoriesNumber(GetCategoriesNumberEventevent,
      Emitter<CategoriesNumberState> emit) async {
